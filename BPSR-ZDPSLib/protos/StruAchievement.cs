...
namespace Zproto {
  ...
  /// <summary>Holder for reflection information generated from stru_achievement.proto</summary>
  public static partial class StruAchievementReflection {

    #region Descriptor
    /// <summary>File descriptor for stru_achievement.proto</summary>
    public static pbr::FileDescriptor Descriptor {
      get { return descriptor; }
    }
    private static pbr::FileDescriptor descriptor;

    static StruAchievementReflection() {
      ...
      descriptor = pbr::FileDescriptor.FromGeneratedCode(descriptorData,
          ...
          new pbr::GeneratedClrTypeInfo(null, null, new pbr::GeneratedClrTypeInfo[] {
            new pbr::GeneratedClrTypeInfo(typeof(global::Zproto.Achievement), global::Zproto.Achievement.Parser, new[]{ "FinishNum", "HasReceived", "BeginProgress" }, null, null, null, null)
          }));
    }
    #endregion
  ...
  #endif
  {
    ...
    public static pbr::MessageDescriptor Descriptor {
      get { return global::Zproto.StruAchievementReflection.Descriptor.MessageTypes[0]; }
    }
    ...
    public Achievement(Achievement other) : this() {
      ...
      beginProgress_ = other.beginProgress_;
    ...
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    public ulong BeginProgress {
      get { return beginProgress_; }
      set {
        beginProgress_ = value;
      }
    }
    ...
    public bool Equals(Achievement other) {
      ...
      if (BeginProgress != other.BeginProgress) return false;
    ...
    public override int GetHashCode() {
      ...
      if (BeginProgress != 0UL) hash ^= BeginProgress.GetHashCode();
    ...
    public void WriteTo(pb::CodedOutputStream output) {
      ...
      if (BeginProgress != 0UL) {
        output.WriteRawTag(24);
        output.WriteUInt64(BeginProgress);
      }
      if (_unknownFields != null) {
    ...
    public int CalculateSize() {
      ...
      if (BeginProgress != 0UL) {
        size += 1 + pb::CodedOutputStream.ComputeUInt64Size(BeginProgress);
      }
      if (_unknownFields != null) {
    ...
    public void MergeFrom(Achievement other) {
      ...
      if (other.BeginProgress != 0UL) {
        BeginProgress = other.BeginProgress;
      }
    ...
    public void MergeFrom(pb::CodedInputStream input) {
      ...
      switch(tag) {
          ...
          case 24: {
            BeginProgress = input.ReadUInt64();
            break;
          }
        }
      }
